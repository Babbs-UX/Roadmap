...
<html>
    ...
    <meta property="og:image" content="https://alyssax.com/x/flowy/assets/meta.png">
    ...
    <meta property="twitter:image" content="https://alyssax.com/x/flowy/assets/meta.png">
    ...
    <body>
        <div id="navigation">
            <div id="leftside">
                ...
                <div id="names">
                    <p id="title">Roadmap</p>
                    <p id="subtitle">C r i m i n a l s</p>
                </div>
            </div>            
            </div>
            <!-- <div id="centerswitch">
            ...
            <div id="buttonsright">
                <div id="removeblock" class="discard">Reset</div>
                <a id="publish" href="https://albiononline.com/en/killboard/guild/I9mMWmXaS1CYdQlHyR2Nbw" target="_blank">Killboard</a>
                <!-- <div id="publish"onclick="TogetherJS(this); return false;">Collaborate</div> -->
        ...
        <div id="leftcard">
            ...
            <p id="header">Add Portal</p>
            <!-- <div id="search">
                <img src="assets/search.svg">
                <input type="text" placeholder="Search blocks">
            </div> -->
            <div id="subnav">
                <div id="triggers" class="navactive side">Small</div>
                <div id="actions" class="navdisabled side">Medium</div>
                <div id="loggers" class="navdisabled side">Large</div>
            </div>
            <div id="blocklist">
                ...
                <div class="blockelem create-flowy noselect">
                    ...
                    <div class="blockin">
                        ...
                        <div class="blocktext">
                            <p class="blocktitle">Blackzone</p>
                        </div>
                    </div>
                </div>
                <div class="blockelem create-flowy noselect">
        ...
        <!-- <div id="propwrap">
            <div id="properties">
                ...
                <div id="propswitch">
                    <div id="dataprop">Tile Information</div>
        ...
        <div id="phpInsert"></div>
        <img style="display: none;" src="test.php">
